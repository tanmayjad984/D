// Merge sort using parallel computition
...
// parallelize the recursive calls to mergeSort using dynamic task scheduling
		#pragma omp parallel
        {
...
int main()
{
    const int n = 10000;
    int arr[n];
    int originalArr[n]; // to store the original unsorted array
